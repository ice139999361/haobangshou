 ...
 *
 */
public class CustomerOrderDaoHisTest extends AbstractTransactionalDataSourceSpringContextTests {

    @Override 
    public String[] getConfigLocations() { 
        // spring+junit自动加载测试配置文件(applicationContext-test-CustomerOrder.xml)
        return new String[] { "classpath:/applicationContext-test-customerOrderHis.xml", "classpath:/applicationContext-test-customerOrderHis.xml" }; 
    } 
