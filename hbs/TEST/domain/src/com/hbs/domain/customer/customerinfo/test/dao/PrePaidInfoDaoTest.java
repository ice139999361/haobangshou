 ...
 *
 */
public class PrePaidInfoDaoTest extends AbstractTransactionalDataSourceSpringContextTests {
    ...
    public void testInsertPrePaidInfo() {
        PrePaidInfoDao prePaidInfoDao = (PrePaidInfoDao)this.getApplicationContext().getBean("customerPrePaidInfoDao");
       ...
       prePaidInfoDao.insertPrePaidInfo(prePaidInfo);
