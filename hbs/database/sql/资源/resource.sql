...
INSERT INTO `resource` (`RESOURCE_ID`,`ACTIONS_ID`,`RESOURCE_NAME`,`DESCRIPTION`,`URL_ADDRESS`,`PARENT`,`IS_MENU`) VALUES (9100,9100,'用户管理','用户管理','/auth/usermanager.jsp',9000,'0');
...
INSERT INTO `resource` (`RESOURCE_ID`,`ACTIONS_ID`,`RESOURCE_NAME`,`DESCRIPTION`,`URL_ADDRESS`,`PARENT`,`IS_MENU`) VALUES (9200,9200,'角色管理','角色管理','/auth/rolemanager.jsp',9000,'0');
...
INSERT INTO `resource` (`RESOURCE_ID`,`ACTIONS_ID`,`RESOURCE_NAME`,`DESCRIPTION`,`URL_ADDRESS`,`PARENT`,`IS_MENU`) VALUES (9300,9300,'权限管理','权限管理','/auth/authmanager.jsp',9000,'0');
