...
INSERT INTO `t_waittask_config_info` (`CONFIG_ID`,`TASK_TYPE`,`BUSINESS_TYPE`,`URL`,`COMMENTS`,`SYSTEM_NAME`,`ROLE_ID`) VALUES ('CUST_ORDER_007','0','客户订单','abc.jp','财务$staffName退回了了客户$businessKey的订单，请您确认！',NULL,NULL);
...
INSERT INTO `t_waittask_config_info` (`CONFIG_ID`,`TASK_TYPE`,`BUSINESS_TYPE`,`URL`,`COMMENTS`,`SYSTEM_NAME`,`ROLE_ID`) VALUES ('CUST_ORDER_009','0','客户订单','abc.jsp','财务$staffName提交了客户$custCode的预付x%，剩余款到发货，但未收到剩余货款，申请先发货，请审批 ！','customer',NULL);
INSERT INTO `t_waittask_config_info` (`CONFIG_ID`,`TASK_TYPE`,`BUSINESS_TYPE`,`URL`,`COMMENTS`,`SYSTEM_NAME`,`ROLE_ID`) VALUES ('CUST_ORDER_010','1','客户订单','abc.jsp','领导$staffName审批了客户$custCode的预付x%，剩余款到发货，但未收到剩余货款，申请先发货，审批意见：同意 ！',NULL,NULL);
INSERT INTO `t_waittask_config_info` (`CONFIG_ID`,`TASK_TYPE`,`BUSINESS_TYPE`,`URL`,`COMMENTS`,`SYSTEM_NAME`,`ROLE_ID`) VALUES ('CUST_ORDER_011','1','客户订单','abc.jsp','领导$staffName审批了客户$custCode的预付x%，剩余款到发货，但未收到剩余货款，申请先发货，审批意见：不同意 ！',NULL,NULL);
INSERT INTO `t_waittask_config_info` (`CONFIG_ID`,`TASK_TYPE`,`BUSINESS_TYPE`,`URL`,`COMMENTS`,`SYSTEM_NAME`,`ROLE_ID`) VALUES ('CUST_ORDER_012','1','客户订单','abc.jsp','客户$custCode的订单$poNo的物料$partNo将于$verDeliveryDate发货，目前货未备齐，请及时催货 ！','customer',NULL);
INSERT INTO `t_waittask_config_info` (`CONFIG_ID`,`TASK_TYPE`,`BUSINESS_TYPE`,`URL`,`COMMENTS`,`SYSTEM_NAME`,`ROLE_ID`) VALUES ('CUST_ORDER_013','1','客户订单','abc.jsp','客户$custCode的订单$poNo的物料$partNo将于$verDeliveryDate发货，目前货已备齐，请及时发货！','customer','changku');
INSERT INTO `t_waittask_config_info` (`CONFIG_ID`,`TASK_TYPE`,`BUSINESS_TYPE`,`URL`,`COMMENTS`,`SYSTEM_NAME`,`ROLE_ID`) VALUES ('CUST_ORDER_014','1','客户订单','abc.jsp','客户$custCode的订单$poNo的物料$partNo将于$verDeliveryDate发货，目前货已备齐，未收款（款到发货），请及时催款 ！','customer',NULL);
INSERT INTO `t_waittask_config_info` (`CONFIG_ID`,`TASK_TYPE`,`BUSINESS_TYPE`,`URL`,`COMMENTS`,`SYSTEM_NAME`,`ROLE_ID`) VALUES ('CUST_ORDER_015','0','客户订单','abc.jsp','客户$custCode的订单$poNo的物料$partNo将于$verDeliveryDate发货，目前货未备齐，请决定是否发货 ！','customer',NULL);
INSERT INTO `t_waittask_config_info` (`CONFIG_ID`,`TASK_TYPE`,`BUSINESS_TYPE`,`URL`,`COMMENTS`,`SYSTEM_NAME`,`ROLE_ID`) VALUES ('CUST_ORDER_016','1','客户订单','abc.jsp','客户$custCode的订单$poNo的物料$partNo将于$verDeliveryDate发货，目前货未备齐，业务决定部分发货，请及时发货！',NULL,NULL);
