 ...
 *
 */
public class CustSendInvoiceHisDaoImpl extends SqlMapClientDaoSupport implements InvoiceInfoDao
{
    /**
     * logger.
     */
    private static final Logger logger = Logger.getLogger(CustSendInvoiceHisDaoImpl.class);
    ...
    public Integer insertInvoiceInfo(InvoiceInfo invoiceInfo) throws DataAccessException {
    	...
    	Integer i = (Integer)getSqlMapClientTemplate().insert("CustSendHis_InvoiceInfo_insertInvoiceInfo", invoiceInfo);
		if (logger.isDebugEnabled()) {
    ...
    public void deleteInvoiceInfo(String pk)throws DataAccessException {
        ...
        getSqlMapClientTemplate().update("CustSendHis_InvoiceInfo_deleteInvoiceInfo", pk);
		if (logger.isDebugEnabled()) {
    ...
    public void updateInvoiceInfo(InvoiceInfo invoiceInfo) throws DataAccessException {
    	...
    	getSqlMapClientTemplate().update("CustSendHis_InvoiceInfo_updateInvoiceInfo", invoiceInfo);
		if (logger.isDebugEnabled()) {
    ...
    public InvoiceInfo findInvoiceInfo(String pk) throws DataAccessException {
        ...
        InvoiceInfo invoiceInfo = (InvoiceInfo) getSqlMapClientTemplate().queryForObject("CustSendHis_InvoiceInfo_findInvoiceInfo", pk);
		if (logger.isDebugEnabled()) {
	...
	public List<InvoiceInfo> listInvoiceInfo(InvoiceInfo invoiceInfo) throws DataAccessException {
        ...
        List<InvoiceInfo> list = getSqlMapClientTemplate().queryForList("CustSendHis_InvoiceInfo_listInvoiceInfo", invoiceInfo);
		if (logger.isDebugEnabled()) {
    ...
    public Integer listInvoiceInfoCount(InvoiceInfo invoiceInfo) throws DataAccessException {
        ...
        Integer count = (Integer)getSqlMapClientTemplate().queryForObject("CustSendHis_InvoiceInfo_listInvoiceInfoCount", invoiceInfo);
		if (logger.isDebugEnabled()) {
