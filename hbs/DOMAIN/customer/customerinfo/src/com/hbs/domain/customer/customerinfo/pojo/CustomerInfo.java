...
public class CustomerInfo extends BaseDomain{
	...
	public String toString() {
		...
		sb.append(enShortName).append(";");
		sb.append(allName).append(";");
		sb.append(enName).append(";");
		sb.append(address).append(";");
		sb.append(enAddress).append(";");
		sb.append(commType).append(";");
		sb.append(commScale).append(";");
		sb.append(webSite).append(";");
		sb.append(representative).append(";");
		sb.append(taxCode).append(";");
		sb.append(companyBranch).append(";");
		sb.append(creditRate).append(";");
		sb.append(creditDesc).append(";");
		sb.append(importantCode).append(";");
		sb.append(importantDesc).append(";");
		sb.append(settlementType).append(";");
		sb.append(settlementDesc).append(";");
		sb.append(currency).append(";");
		sb.append(currencyDesc).append(";");
		sb.append(staffId).append(";");
		sb.append(staffName).append(";");
		sb.append(commDesc).append(";");
		sb.append(vendorCode).append(";");
		sb.append(contactFee).append(";");
