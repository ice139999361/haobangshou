...
var PageName = '仓库出库单修改';
var PageId = 'pbcd81f83fb72476e943f857223bf49a5'
var PageUrl = '仓库出库单修改.html'
document.title = '仓库出库单修改';
...
InsertBeforeEnd(u109based, "<div class='anncontent'><span class='annfieldname'>功能说明:</span> 删除本行记录<BR><BR></div>");
...
InsertBeforeEnd(u106based, "<div class='anncontent'><span class='annfieldname'>功能说明:</span> 临时保存，临时保存的数据可以做修改操作，成功后，清空<BR><BR></div>");
...
InsertBeforeEnd(u14based, "<div class='anncontent'><span class='annfieldname'>功能说明:</span> 备注，可不填，要大一点<BR><BR></div>");
...
InsertBeforeEnd(u107based, "<div class='anncontent'><span class='annfieldname'>功能说明:</span> 提交出库单及明细，提交后的数据不能修改，成功后，打印按钮可用<BR><BR></div>");
...
InsertBeforeEnd(u101based, "<div class='anncontent'><span class='annfieldname'>功能说明:</span> 编辑框，用户填写，这列可能要大一点，便于输入<BR><BR></div>");
...
x = 0;
y = 0;
InsertAfterBegin(document.getElementById('u100ann'), "<div id='u100Note' class='annnoteimage' style='left:" + x + ";top:" + y + "' onclick=\"ToggleWorkflow(event, 'u100', 300, 300, false)\"></div>");
...
InsertBeforeEnd(u100based, "<div class='anncontent'><span class='annfieldname'>功能说明:</span> 编辑框，用户填写<BR><BR></div>");
...
InsertBeforeEnd(u12based, "<div class='anncontent'><span class='annfieldname'>功能说明:</span> 前一页面带入，不允许修改<BR><BR></div>");
...
x = 0;
y = 0;
InsertAfterBegin(document.getElementById('u121ann'), "<div id='u121Note' class='annnoteimage' style='left:" + x + ";top:" + y + "' onclick=\"ToggleWorkflow(event, 'u121', 300, 300, false)\"></div>");
...
InsertBeforeEnd(u121based, "<div class='anncontent'><span class='annfieldname'>功能说明:</span> 提交后方能打印<BR><BR></div>");
...
InsertBeforeEnd(u18based, "<div class='anncontent'><span class='annfieldname'>功能说明:</span> 添加出库单明细，把用户选择的放入列表，允许多次添加<BR><BR></div>");
...
if (true) {
	...
	NewWindow("选择客户订单_1.html" + GetQuerystring(), "", "directories=1, height=400, location=1, menubar=1, resizable=1, scrollbars=1, status=1, toolbar=1, width=600", true, 600, 400);
...
InsertBeforeEnd(u112based, "<div class='anncontent'><span class='annfieldname'>功能说明:</span> 用户选择选择收货人，必填<br>收货人的下拉列表框的初始化，是在用户选择了客户后，查询联系人信息表初始化的<BR><BR></div>");
...
InsertBeforeEnd(u122based, "<div class='anncontent'><span class='annfieldname'>功能说明:</span> 前一页面带入，不允许修改<BR><BR></div>");
...
InsertBeforeEnd(u108based, "<div class='anncontent'><span class='annfieldname'>功能说明:</span> 删除本行记录<BR><BR></div>");
...
InsertBeforeEnd(u114based, "<div class='anncontent'><span class='annfieldname'>功能说明:</span> 缺省值为：根据用户选择的联系人自动填充<br>允许用户修改<BR><BR></div>");
...
InsertBeforeEnd(u123based, "<div class='anncontent'><span class='annfieldname'>功能说明:</span> 前一页面带入，不允许修改<BR><BR></div>");
