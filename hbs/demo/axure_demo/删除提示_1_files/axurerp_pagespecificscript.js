...
var PageName = '删除提示';
var PageId = 'pbcc24acd38cd44758fe8b126edba4bb1'
var PageUrl = '删除提示_1.html'
document.title = '删除提示';
...
InsertBeforeEnd(u4based, "<div class='anncontent'><span class='annfieldname'>功能说明:</span> 返回角色管理界面<BR><BR></div>");
...
InsertBeforeEnd(u3based, "<div class='anncontent'><span class='annfieldname'>功能说明:</span> 用户确定，删除角色，并刷新角色管理页面<BR><BR></div>");
