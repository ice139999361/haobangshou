...
var PageName = '仓库出库单查询';
var PageId = 'p5a41c2e8b5644fb4805b5ab9be673fea'
var PageUrl = '仓库出库单查询.html'
document.title = '仓库出库单查询';
...
InsertBeforeEnd(u96based, "<div class='anncontent'><span class='annfieldname'>功能说明:</span> 出库单的状态只能在临时保存的情况下才能修改 ，state=01<br>弹出详情叶面，供修改<BR><BR></div>");
...
if (true) {
	...
	NewWindow("仓库出库单修改.html" + GetQuerystring(), "", "directories=1, height=500, location=1, menubar=1, resizable=1, scrollbars=1, status=1, toolbar=1, width=500", true, 500, 500);
...
InsertBeforeEnd(u93based, "<div class='anncontent'><span class='annfieldname'>功能说明:</span> 出库单的状态只能在临时保存的情况下才能删除 ，state=01<br>提示用户是否删除出库单及出库单下的所有明细？<BR><BR></div>");
...
if (true) {
	...
	NewWindow("出库但详情查看.html" + GetQuerystring(), "", "directories=1, height=500, location=1, menubar=1, resizable=1, scrollbars=1, status=1, toolbar=1, width=500", true, 500, 500);
...
InsertBeforeEnd(u94based, "<div class='anncontent'><span class='annfieldname'>功能说明:</span> 出库单的状态只能在临时保存的情况下才能修改 ，state=01<br>弹出详情叶面，供修改<BR><BR></div>");
...
InsertBeforeEnd(u95based, "<div class='anncontent'><span class='annfieldname'>功能说明:</span> 出库单的状态只能在临时保存的情况下才能删除 ，state=01<br>提示用户是否删除出库单及出库单下的所有明细？<BR><BR></div>");
...
InsertBeforeEnd(u92based, "<div class='anncontent'><span class='annfieldname'>功能说明:</span> 用户选择状态，type=WAREHOUSE_RECINFO<BR><BR></div>");
