...
var PageName = '用户自修改密码';
var PageId = 'p429bfec8e0624625a3988fa6416d23e6'
var PageUrl = '用户自修改密码.html'
document.title = '用户自修改密码';
...
InsertBeforeEnd(u5based, "<div class='anncontent'><span class='annfieldname'>功能说明:</span> 以×显示密码<BR><BR></div>");
...
InsertBeforeEnd(u3based, "<div class='anncontent'><span class='annfieldname'>功能说明:</span> 以×显示密码<BR><BR></div>");
...
InsertBeforeEnd(u9based, "<div class='anncontent'><span class='annfieldname'>功能说明:</span> 不做任何操作，关闭此窗口<BR><BR></div>");
...
InsertBeforeEnd(u7based, "<div class='anncontent'><span class='annfieldname'>功能说明:</span> 以×显示密码<BR><BR></div>");
...
InsertBeforeEnd(u8based, "<div class='anncontent'><span class='annfieldname'>功能说明:</span> 保存新密码，关闭当前窗口，保存前需要校验旧密码是否正确<BR><BR></div>");
