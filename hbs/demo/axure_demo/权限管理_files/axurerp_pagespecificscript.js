...
var PageName = '权限管理';
var PageId = 'p1156df8e49cd457abc8bbea2dd6fb787'
...
if (true) {
	...
	NewWindow("权限信息详情.html" + GetQuerystring(), "", "directories=1, height=500, location=1, menubar=1, resizable=1, scrollbars=1, status=1, toolbar=1, width=500", true, 500, 500);
...
if (true) {
	...
	NewWindow("修改权限.html" + GetQuerystring(), "", "directories=1, height=500, location=1, menubar=1, resizable=1, scrollbars=1, status=1, toolbar=1, width=500", true, 500, 500);
...
if (true) {
	...
	NewWindow("删除提示_2.html" + GetQuerystring(), "", "directories=1, height=500, location=1, menubar=1, resizable=1, scrollbars=1, status=1, toolbar=1, width=500", true, 500, 500);
...
InsertBeforeEnd(u5based, "<div class='anncontent'><span class='annfieldname'>功能说明:</span> 支持模糊查询<BR><BR></div>");
...
if (true) {
	...
	NewWindow("新增帐号权限.html" + GetQuerystring(), "", "directories=1, height=500, location=1, menubar=1, resizable=1, scrollbars=1, status=1, toolbar=1, width=500", true, 500, 500);
...
InsertBeforeEnd(u4based, "<div class='anncontent'><span class='annfieldname'>功能说明:</span> 支持模糊查询<BR><BR></div>");
