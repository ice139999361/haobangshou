...
var PageName = '删除提示';
var PageId = 'p096f589194464e2dbe6d2d098ff4819f'
var PageUrl = '删除提示_2.html'
document.title = '删除提示';
...
InsertBeforeEnd(u4based, "<div class='anncontent'><span class='annfieldname'>功能说明:</span> 返回权限管理界面<BR><BR></div>");
...
InsertBeforeEnd(u3based, "<div class='anncontent'><span class='annfieldname'>功能说明:</span> 用户确定，删除权限，并刷新权限管理页面<BR><BR></div>");
