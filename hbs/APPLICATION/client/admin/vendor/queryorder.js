...
HBSConvertHelper.init(function() {
	...
	querygrid.getView().on("refresh", function(view) {
		...
		for(var i = 0 ; i < view.ds.getCount() ; i++) {
			...
			// 将需要的链接渲染到此列
			HBSConvertHelper.renderATag2Cell(poNo_cell.innerText, "/vendor/detailorder.jsp?pageType=query&poNo=" + record.get("poNo") + "&commCode=" + record.get("commCode") + "&roleType=" + urlPs.roleType, "open", poNo_cell);
