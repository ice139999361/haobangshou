HBSConvertHelper.init(function() {
	...
	(function() {		
		...
		historyBtn.on("click", function() {
			HBSConvertHelper.open("/complex/detailhistory.jsp", 800, 500, {gridurl: ["/vendorInfo/vendorPartNoInfo!getPriceChange.action?vendorPartNoInfo.commCode=", Ext.getCmp("commCode").getValue(), "&vendorPartNoInfo.custPartNo=", Ext.getCmp("custPartNo").getValue(), "&vendorPartNoInfo.partNo=", Ext.getCmp("partNo").getValue()].join("")})
		});
