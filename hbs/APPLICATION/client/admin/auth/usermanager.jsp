			    	...
			    	<!-- service ext ui.  begin. -->
			    		...
			    		<queryform gridId="querygrid">
			    			<layoutpanel columnNum="3">
			    				<textfield fieldLabel="姓名"                   name="vendorInfo.representative"       />
			    				<textfield fieldLabel="职务"                   name="vendorInfo.allName"              />
			    				<textfield fieldLabel="帐号"                   name="vendorInfo.commCode"             />
			    			</layoutpanel>
			    		</queryform>
				    	...
				    	<complexgrid id="querygrid" title="用户列表" frame="true" page="true" root="data.list" url="/auth/user!list.action">
			    			...
			    			<columns>
			    				<column header="帐号"     dataIndex="staffName" id="staffName" />
			    				<column header="姓名"     dataIndex="name"      />
