HBSConvertHelper.init(function() {
	...
	(function() {		
		...
		historyBtn.on("click", function() {
			HBSConvertHelper.open("/complex/detailhistory.jsp", 800, 500, {gridurl: ["/customerInfo/custPartNoInfo!getPriceChange.action?custPartNoInfo.commCode=", Ext.getCmp("commCode").getValue(), "&custPartNoInfo.custPartNo=", Ext.getCmp("custPartNo").getValue(), "&custPartNoInfo.partNo=", Ext.getCmp("partNo").getValue()].join("")})
		});
