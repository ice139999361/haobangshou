			    ...
			    <panel frame="true" autoScroll="true">
			    	...
			    	<!-- service ext ui.  begin. -->
			    		<queryform gridId="querygrid">
							...
							<dictcombo fieldLabel="业务员"       hiddenName="corderDetail.salesId"     labelStyle="width:150"  url="/auth/user!listByRoleId.action?roleId=5" root="data.list"  displayField="staffName"  valueField="staffId" allowBlank="false"/>
				    	...
				    	<complexgrid id="querygrid" title="未发货客户订单明细列表" frame="true" page="true" root="data.list" url="/custOrderDetail/orderDetail!listNoCommitMgr.action">
				    		<fields>
