...
//                .getBeanInfo(clazz);
            ...
            // jsonplugin bug, modified 2008-06-22 end            
            ...
            for (int i = 0; i < props.length; ++i) {
                ...
                if (baseAccessor != null) {
                    ...
                    // 按json转义名称输出json字符串
                    this.add(jsonName, value, accessor);
                    if (this.buildExpr) {
