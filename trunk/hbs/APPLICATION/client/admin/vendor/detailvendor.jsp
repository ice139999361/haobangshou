			    		...
			    		<form id="form"><items>
				    		<listpanel frame="true" title="供应商基本信息" collapsible="true" titleCollapse="true">
				    			<layoutpanel columnNum="2">
				    				...
				    				<label fieldLabel="中文名称"               name="custInfo.allName"              labelStyle="width:150" />
				    				<label fieldLabel="供应商简称"             name="custInfo.shortName"            labelStyle="width:150" allowBlank="false"/>
				    				<label fieldLabel="公司地址"               name="custInfo.address"              labelStyle="width:150" />
				    				<label fieldLabel="信用度"                 hiddenName="custInfo.creditRate"     labelStyle="width:150" paramsValue="CREDIT_RATE"     emptyText="请选择" />	
				    				<label fieldLabel="重要程度"               hiddenName="custInfo.importantCode"  labelStyle="width:150" paramsValue="IMPORTANT_CODE"  emptyText="请选择" />
				    				<label fieldLabel="纳税人识别号"           name="custInfo.taxCode"              labelStyle="width:150" />
				    				<label fieldLabel="性质"                   name="custInfo.commType"             labelStyle="width:150" />
				    				<label fieldLabel="操作人员ID"             name="custInfo.staffId"              labelStyle="width:150" />
				    				<label fieldLabel="对应的分公司或分支机构" hiddenName="custInfo.companyBranch"  labelStyle="width:150" paramsValue="COMPANY_BRANCH"  emptyText="请选择" />			
				    				
				    				<label fieldLabel="法人代表"               name="custInfo.representative"       labelStyle="width:150" />
				    				<label fieldLabel="英文名称"               name="custInfo.enName"               labelStyle="width:150" />
				    				...
				    				<label fieldLabel="信用等级描述"           name="custInfo.address"              labelStyle="width:150" />
				    				<label fieldLabel="重要程度描述"           name="custInfo.address"              labelStyle="width:150" />	
				    				<label fieldLabel="公司网址"               name="custInfo.webSite"              labelStyle="width:150" />
				    				<label fieldLabel="规模"                   name="custInfo.commScale"            labelStyle="width:150" />
				    				<label fieldLabel="操作人员名字"           name="custInfo.staffName"            labelStyle="width:150" />
				    				<label fieldLabel="是否显示单价"           hiddenName="custInfo.isShowPrice"    labelStyle="width:150" paramsValue="IS_SHOW_PRICE"   emptyText="请选择" />
				    			</layoutpanel>
				    			
				    			<layoutpanel columnNum="1">
				    				<label fieldLabel="备注"                    name="custInfo.commDesc"             labelStyle="width:150"/>
				    			</layoutpanel>
				    		...
				    		<listpanel frame="true" title="结算信息" collapsible="true" titleCollapse="true">
				    			<layoutpanel columnNum="2">
				    				<label fieldLabel="结算类型"               hiddenName="custInfo.settlementType"            labelStyle="width:150" paramsValue="SETTLEMENT_TYPE" emptyText="请选择" />
				    				<label fieldLabel="结算币种"               hiddenName="custInfo.currency"                  labelStyle="width:150" paramsValue="CURRENCY"        emptyText="请选择" />	
				    				<label fieldLabel="合同费"                 name="custInfo.contactFee"                      labelStyle="width:150" />
				    				<label fieldLabel="账期类型" 			         hiddenName="custInfo.accountPreiod.accountType" labelStyle="width:150" paramsValue="ACCOUNT_TYPE" emptyText="请选择" />
				    				...
				    				<label fieldLabel="结算方式描述" 	         name="custInfo.accountPreiod.accountPeriod"     labelStyle="width:150" />
				    				<label fieldLabel="结算币种描述" 	         name="custInfo.accountPreiod.accountPeriod"     labelStyle="width:150" />
				    				<label fieldLabel="税率"                   name="custInfo.taxRate"                         labelStyle="width:150" />	
				    				<label fieldLabel="供应商的账期设置" 		   name="custInfo.accountPreiod.accountPeriod"     labelStyle="width:150" />	
				    				...
				    				<label fieldLabel="提醒人" 			           name="custInfo.prePaidInfo.reminderDay"         labelStyle="width:150" />
				    			</layoutpanel>
