HBSConvertHelper.init(function() {
	...
	querygrid.getView().on("refresh", function(view) {
		...
		for(var i = 0 ; i < view.ds.getCount() ; i++) {
			...
			// 将需要的链接渲染到此列
			HBSConvertHelper.renderATag2Cell(cpartNo_cell.innerText, "/materiel/querymateriel.jsp?pageType=query&partNo="+view.ds.getAt(i).get("cpartNo"), "open", cpartNo_cell);
