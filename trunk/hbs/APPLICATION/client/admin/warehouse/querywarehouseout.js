HBSConvertHelper.init(function() {
	...
	querygrid.getView().on("refresh", function(view) {
		...
		for(var i = 0 ; i < view.ds.getCount() ; i++) {
			...
			// 将需要的链接渲染到此列
			HBSConvertHelper.renderATag2Cell(csendpono_cell.innerText, "/warehouse/detailwarehouseout.jsp?pageType=query&partNo="+view.ds.getAt(i).get("cpartNo"), "open", csendpono_cell);
