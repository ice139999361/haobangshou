...
Ext.apply(ExtConvertHelper, {
	extProConvertMap: {
	 		 // 将会做出自动转换，属性名之间用 "," 分隔
	 		 "boolean" : "editorFlag,fileUpload,allowBlank,deftbar,sortable,page,enableTabScroll,closable,frame,displayIcon,split,collapsible,preloadChildren,expanded,singleClickExpand"
