			    	...
			    	<!-- service ext ui.  begin. -->
				    		...
				    		<listpanel frame="true" title="发票基本信息" collapsible="true" titleCollapse="true">
				    			<layoutpanel columnNum="2">
				    				...
				    				<label        fieldLabel="发货单号"        name="invoice.poNo"                         labelStyle="width:150"/>
...
<script type="text/javascript" src="<%=contextPath %>/invoice/detailcustomerinvoiced.js"></script>