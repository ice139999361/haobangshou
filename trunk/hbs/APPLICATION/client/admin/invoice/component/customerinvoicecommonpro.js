var queryformFun = function() {	
	...
	p1.push({fieldLabel: "客户编码", name: "", xtype: "textfield", labelStyle: "width:150"});
	p1.push({fieldLabel: "客户简称", name: "", xtype: "textfield", labelStyle: "width:150"});
	p1.push({fieldLabel: "发货单号"  , name: "", xtype: "textfield", labelStyle: "width:150"});


	var p2 = cph.createLayoutPanel("6:.3333,.11,.05,.15,.05,.3");
	p2.push({fieldLabel: "客户编码", name: "", xtype: "textfield", labelStyle: "width:150"});
...
var querygridFun = function() {
	...
	cgh.appendColumn({header: "发货单号"  , dataIndex: "l3"});
