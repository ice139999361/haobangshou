 ...
 *
 */
public class CustSendInvoiceDaoImpl extends SqlMapClientDaoSupport implements InvoiceInfoDao
{
    /**
     * logger.
     */
    private static final Logger logger = Logger.getLogger(CustSendInvoiceDaoImpl.class);
