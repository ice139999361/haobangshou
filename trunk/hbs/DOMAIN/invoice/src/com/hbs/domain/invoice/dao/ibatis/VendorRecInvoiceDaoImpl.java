...
public class VendorRecInvoiceDaoImpl extends SqlMapClientDaoSupport implements InvoiceInfoDao
{
    ...
    public Integer insertInvoiceInfo(InvoiceInfo invoiceInfo) throws DataAccessException {
    	...
    	Integer i = (Integer)getSqlMapClientTemplate().insert("VendorRec_InvoiceInfo_insertInvoiceInfo", invoiceInfo);
		if (logger.isDebugEnabled()) {
    ...
    public void deleteInvoiceInfo(String pk)throws DataAccessException {
        ...
        getSqlMapClientTemplate().update("VendorRec_InvoiceInfo_deleteInvoiceInfo", pk);
		if (logger.isDebugEnabled()) {
    ...
    public void updateInvoiceInfo(InvoiceInfo invoiceInfo) throws DataAccessException {
    	...
    	getSqlMapClientTemplate().update("VendorRec_InvoiceInfo_updateInvoiceInfo", invoiceInfo);
		if (logger.isDebugEnabled()) {
    ...
    public InvoiceInfo findInvoiceInfo(String pk) throws DataAccessException {
        ...
        InvoiceInfo invoiceInfo = (InvoiceInfo) getSqlMapClientTemplate().queryForObject("VendorRec_InvoiceInfo_findInvoiceInfo", pk);
		if (logger.isDebugEnabled()) {
	...
	public List<InvoiceInfo> listInvoiceInfo(InvoiceInfo invoiceInfo) throws DataAccessException {
        ...
        List<InvoiceInfo> list = getSqlMapClientTemplate().queryForList("VendorRec_InvoiceInfo_listInvoiceInfo", invoiceInfo);
		if (logger.isDebugEnabled()) {
    ...
    public Integer listInvoiceInfoCount(InvoiceInfo invoiceInfo) throws DataAccessException {
        ...
        Integer count = (Integer)getSqlMapClientTemplate().queryForObject("VendorRec_InvoiceInfo_listInvoiceInfoCount", invoiceInfo);
		if (logger.isDebugEnabled()) {
