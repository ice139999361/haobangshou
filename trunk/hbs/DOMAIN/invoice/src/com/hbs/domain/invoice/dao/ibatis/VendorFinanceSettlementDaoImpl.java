 ...
 *
 */
public class VendorFinanceSettlementDaoImpl extends SqlMapClientDaoSupport implements FinanceSettlementDao
{
    /**
     * logger.
     */
    private static final Logger logger = Logger.getLogger(VendorFinanceSettlementDaoImpl.class);
    ...
    public void insertFinanceSettlement(FinanceSettlement financeSettlement) throws DataAccessException {
    	...
    	getSqlMapClientTemplate().insert("VendorFinanceSettlement_insertFinanceSettlement", financeSettlement);
		if (logger.isDebugEnabled()) {
    ...
    public void updateFinanceSettlement(FinanceSettlement financeSettlement) throws DataAccessException {
    	...
    	getSqlMapClientTemplate().update("VendorFinanceSettlement_updateFinanceSettlement", financeSettlement);
		if (logger.isDebugEnabled()) {
    ...
    public FinanceSettlement findFinanceSettlement(FinanceSettlement financeSettlement) throws DataAccessException {
        ...
        FinanceSettlement financeSettle = (FinanceSettlement) getSqlMapClientTemplate().queryForObject("VendorFinanceSettlement_findFinanceSettlement", financeSettlement);
		if (logger.isDebugEnabled()) {
	...
	public List<FinanceSettlement> listFinanceSettlement(FinanceSettlement financeSettlement) throws DataAccessException {
        ...
        List<FinanceSettlement> list = getSqlMapClientTemplate().queryForList("VendorFinanceSettlement_listFinanceSettlement", financeSettlement);
		if (logger.isDebugEnabled()) {
    ...
    public Integer listFinanceSettlementCount(FinanceSettlement financeSettlement) throws DataAccessException {
        ...
        Integer count = (Integer)getSqlMapClientTemplate().queryForObject("VendorFinanceSettlement_listFinanceSettlementCount", financeSettlement);
		if (logger.isDebugEnabled()) {
