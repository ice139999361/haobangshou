 ...
 *
 */
public class VendorOperLogHisDaoImpl extends SqlMapClientDaoSupport implements OperLogDao
{
    /**
     * logger.
     */
    private static final Logger logger = Logger.getLogger(VendorOperLogHisDaoImpl.class);
    ...
    public void insertOperLog(OperLog operLog) throws DataAccessException {
    	...
    	getSqlMapClientTemplate().insert("Vendor_OperLogHis_insertOperLog", operLog);
		if (logger.isDebugEnabled()) {
    ...
    public OperLog findOperLog(String pk) throws DataAccessException {
        ...
        OperLog operLog = (OperLog) getSqlMapClientTemplate().queryForObject("Vendor_OperLogHis_findOperLog", pk);
		if (logger.isDebugEnabled()) {
	...
	public List<OperLog> listOperLog(String operKey) throws DataAccessException {
        ...
        List<OperLog> list = getSqlMapClientTemplate().queryForList("Vendor_OperLogHis_listOperLog", operKey);
		if (logger.isDebugEnabled()) {
