...
public class OperLogHisDaoImpl extends SqlMapClientDaoSupport implements OperLogDao
{
    ...
    public void insertOperLog(OperLog operLog) throws DataAccessException {
    	...
    	getSqlMapClientTemplate().insert("OperLogHis_insertOperLog", operLog);
		if (logger.isDebugEnabled()) {
    ...
    public OperLog findOperLog(String pk) throws DataAccessException {
        ...
        OperLog operLog = (OperLog) getSqlMapClientTemplate().queryForObject("OperLogHis_findOperLog", pk);
		if (logger.isDebugEnabled()) {
	...
	public List<OperLog> listOperLog(String operKey) throws DataAccessException {
        ...
        List<OperLog> list = getSqlMapClientTemplate().queryForList("OperLogHis_listOperLog", operKey);
		if (logger.isDebugEnabled()) {
