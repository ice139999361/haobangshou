 ...
 *
 */
public class OperLogHisDaoImpl extends SqlMapClientDaoSupport implements OperLogDao
{
    /**
     * logger.
     */
    private static final Logger logger = Logger.getLogger(OperLogDaoImpl.class);
    ...
    public void insertOperLog(OperLog operLog) throws DataAccessException {
    	...
    	getSqlMapClientTemplate().insert("Cust_OperLogHis_insertOperLog", operLog);
		if (logger.isDebugEnabled()) {
    ...
    public OperLog findOperLog(String pk) throws DataAccessException {
        ...
        OperLog operLog = (OperLog) getSqlMapClientTemplate().queryForObject("Cust_OperLogHis_findOperLog", pk);
		if (logger.isDebugEnabled()) {
	...
	public List<OperLog> listOperLog(String operKey) throws DataAccessException {
        ...
        List<OperLog> list = getSqlMapClientTemplate().queryForList("Cust_OperLogHis_listOperLog", operKey);
		if (logger.isDebugEnabled()) {
