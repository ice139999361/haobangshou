 ...
 *
 */
public class WarehouseOperLogHisDaoImpl extends SqlMapClientDaoSupport implements OperLogDao
{
    /**
     * logger.
     */
    private static final Logger logger = Logger.getLogger(WarehouseOperLogHisDaoImpl.class);
    ...
    public void insertOperLog(OperLog operLog) throws DataAccessException {
    	...
    	getSqlMapClientTemplate().insert("WareHouse_OperLogHis_insertOperLog", operLog);
		if (logger.isDebugEnabled()) {
    ...
    public OperLog findOperLog(String pk) throws DataAccessException {
        ...
        OperLog operLog = (OperLog) getSqlMapClientTemplate().queryForObject("WareHouse_OperLogHis_findOperLog", pk);
		if (logger.isDebugEnabled()) {
	...
	public List<OperLog> listOperLog(OperLog operKey) throws DataAccessException {
        ...
        List<OperLog> list = getSqlMapClientTemplate().queryForList("WareHouse_OperLogHis_listOperLog", operKey);
		if (logger.isDebugEnabled()) {
