 ...
 *
 */
public class WarehouseOperLogDaoImpl extends SqlMapClientDaoSupport implements OperLogDao
{
    /**
     * logger.
     */
    private static final Logger logger = Logger.getLogger(WarehouseOperLogDaoImpl.class);
