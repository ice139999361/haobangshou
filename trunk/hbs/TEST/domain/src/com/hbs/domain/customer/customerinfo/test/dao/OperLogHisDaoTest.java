 ...
 *
 */
public class OperLogHisDaoTest extends AbstractTransactionalDataSourceSpringContextTests {

    @Override 
    public String[] getConfigLocations() { 
        // spring+junit自动加载测试配置文件(applicationContext-test-OperLog.xml)
        return new String[] { "classpath:/applicationContext-test-operLogHis.xml", "classpath:/applicationContext-test-operLogHis.xml" }; 
    } 
    ...
    public void testInsertOperLog() {
        OperLogDao operLogDao = (OperLogDao)this.getApplicationContext().getBean("operLogHisDao");
