 ...
 *
 */
public class CustOrderDetailHisDaoTest extends AbstractTransactionalDataSourceSpringContextTests {

    @Override 
    public String[] getConfigLocations() { 
        // spring+junit自动加载测试配置文件(applicationContext-test-CustOrderDetail.xml)
        return new String[] { "classpath:/applicationContext-test-custOrderDetailHis.xml", "classpath:/applicationContext-test-custOrderDetailHis.xml" }; 
    } 
