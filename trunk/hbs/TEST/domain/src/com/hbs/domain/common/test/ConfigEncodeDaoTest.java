...
public class ConfigEncodeDaoTest extends AbstractTransactionalDataSourceSpringContextTests {
    ...
    public String[] getConfigLocations() { 
        ...
        return new String[] { "classpath:/applicationContext-test-configEncode.xml", "classpath:/applicationContext-test-configEncode.xml" }; 
    } 
...
//        configEncode1.setEncodeType("yangzj");
//        configEncode1.setEncodeKey("a");
//        ConfigEncode configEncode = configEncodeDao.findConfigEncode(configEncode1);
//        
