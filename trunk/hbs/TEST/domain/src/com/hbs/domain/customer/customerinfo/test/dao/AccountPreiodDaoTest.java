 ...
 *
 */
public class AccountPreiodDaoTest extends AbstractTransactionalDataSourceSpringContextTests {
    ...
    public void testInsertAccountPreiod() {
        AccountPreiodDao accountPreiodDao = (AccountPreiodDao)this.getApplicationContext().getBean("customerAccountPreiodDao");
        ...
        accountPreiodDao.insertAccountPreiod(accountPreiod);
