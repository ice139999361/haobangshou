...
var PageName = '选择客户订单';
var PageId = 'p788fc0dccf644b5f983ccf4abb646edf'
var PageUrl = '选择客户订单_1.html'
document.title = '选择客户订单';
...
InsertBeforeEnd(u13based, "<div class='anncontent'><span class='annfieldname'>功能说明:</span> 根据用户输入的条件查询出客户订单，包括隐含条件，订单单明细中订货数量 》 已出库的数量及订单明细状态为70<BR><BR></div>");
...
InsertBeforeEnd(u6based, "<div class='anncontent'><span class='annfieldname'>功能说明:</span> 用户输入客户的订单号 ,可不填<BR><BR></div>");
