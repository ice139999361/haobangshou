...
var PageName = '用户信息详情';
var PageId = 'p0b3cbfc35ad146f78b3228e98eea6ac4'
var PageUrl = '用户信息详情.html'
document.title = '用户信息详情';
...
InsertBeforeEnd(u15based, "<div class='anncontent'><span class='annfieldname'>功能说明:</span> １８位长<BR><BR></div>");
...
InsertBeforeEnd(u22based, "<div class='anncontent'><span class='annfieldname'>功能说明:</span> 并关闭此界面到用户管理界面<BR><BR></div>");
...
InsertBeforeEnd(u17based, "<div class='anncontent'><span class='annfieldname'>功能说明:</span> 需要按照邮箱格式校验<BR><BR></div>");
