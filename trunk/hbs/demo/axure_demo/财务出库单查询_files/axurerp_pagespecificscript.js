...
var PageName = '财务出库单查询';
var PageId = 'pa1cedccfa8e94c26906c4c293ecef390'
var PageUrl = '财务出库单查询.html'
document.title = '财务出库单查询';
...
if (true) {
	...
	NewWindow("出库但详情查看_1.html" + GetQuerystring(), "", "directories=1, height=500, location=1, menubar=1, resizable=1, scrollbars=1, status=1, toolbar=1, width=500", true, 500, 500);
