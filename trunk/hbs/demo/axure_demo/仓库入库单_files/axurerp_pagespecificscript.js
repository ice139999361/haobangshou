...
var PageName = '仓库入库单';
var PageId = 'p204a01558fb74a9ab769c43cc1e892ac'
var PageUrl = '仓库入库单.html'
document.title = '仓库入库单';
...
InsertBeforeEnd(u109based, "<div class='anncontent'><span class='annfieldname'>功能说明:</span> 编辑框，用户填写，这列可能要大一点，便于输入<BR><BR></div>");
...
InsertBeforeEnd(u110based, "<div class='anncontent'><span class='annfieldname'>功能说明:</span> 临时保存，临时保存的数据可以做修改操作，成功后，清空<BR><BR></div>");
...
InsertBeforeEnd(u14based, "<div class='anncontent'><span class='annfieldname'>功能说明:</span> 用户选择仓库，必填<BR><BR></div>");
...
InsertBeforeEnd(u12based, "<div class='anncontent'><span class='annfieldname'>功能说明:</span> 用户选择供应商，必填<br>供应商的状态必须为正常的供应商<BR><BR></div>");
...
InsertBeforeEnd(u18based, "<div class='anncontent'><span class='annfieldname'>功能说明:</span> 备注，可不填，要大一点<BR><BR></div>");
...
InsertBeforeEnd(u22based, "<div class='anncontent'><span class='annfieldname'>功能说明:</span> 添加入库单明细，把用户选择的放入列表，允许多次添加<BR><BR></div>");
...
if (true) {
	...
	NewWindow("选择供应商采购单.html" + GetQuerystring(), "", "directories=1, height=400, location=1, menubar=1, resizable=1, scrollbars=1, status=1, toolbar=1, width=600", true, 600, 400);
...
InsertBeforeEnd(u108based, "<div class='anncontent'><span class='annfieldname'>功能说明:</span> 编辑框，用户填写<BR><BR></div>");
...
InsertBeforeEnd(u113based, "<div class='anncontent'><span class='annfieldname'>功能说明:</span> 删除本行记录<BR><BR></div>");
...
InsertBeforeEnd(u114based, "<div class='anncontent'><span class='annfieldname'>功能说明:</span> 删除本行记录<BR><BR></div>");
...
InsertBeforeEnd(u111based, "<div class='anncontent'><span class='annfieldname'>功能说明:</span> 提交入库单及明细，提交后的数据不能修改，成功后，清空<BR><BR></div>");
...
InsertBeforeEnd(u16based, "<div class='anncontent'><span class='annfieldname'>功能说明:</span> 填单日期缺省值为当天日期，用户可以修改，格式为YYYY-MM-DD<BR><BR></div>");
...
InsertBeforeEnd(u10based, "<div class='anncontent'><span class='annfieldname'>功能说明:</span> 用户根据供应商的送货单日期输入，必填<BR><BR></div>");
