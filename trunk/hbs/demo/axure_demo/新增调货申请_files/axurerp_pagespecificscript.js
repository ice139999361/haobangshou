...
var PageName = '新增调货申请';
var PageId = 'pa7b69eb390bc49628319365c260e2f6b'
var PageUrl = '新增调货申请.html'
document.title = '新增调货申请';
...
InsertBeforeEnd(u7based, "<div class='anncontent'><span class='annfieldname'>功能说明:</span> 用户输入，输入完毕，根据供应商判断是否存在该物料对照关系<BR><BR></div>");
...
InsertBeforeEnd(u15based, "<div class='anncontent'><span class='annfieldname'>功能说明:</span> 只读，自动填充<BR><BR></div>");
...
InsertBeforeEnd(u19based, "<div class='anncontent'><span class='annfieldname'>功能说明:</span> 用户输入<BR><BR></div>");
...
InsertBeforeEnd(u13based, "<div class='anncontent'><span class='annfieldname'>功能说明:</span> 用户输入<BR><BR></div>");
...
InsertBeforeEnd(u5based, "<div class='anncontent'><span class='annfieldname'>功能说明:</span> 只读框，根据当前自动填充<BR><BR></div>");
...
InsertBeforeEnd(u21based, "<div class='anncontent'><span class='annfieldname'>功能说明:</span> 只读，自动填充<BR><BR></div>");
...
InsertBeforeEnd(u17based, "<div class='anncontent'><span class='annfieldname'>功能说明:</span> 用户输入，做数字校验<br><br>同时需要到后台校验，判断库存是否满足调货要求<BR><BR></div>");
...
InsertBeforeEnd(u3based, "<div class='anncontent'><span class='annfieldname'>功能说明:</span> 只读框，根据登录信息自动填充<BR><BR></div>");
...
InsertBeforeEnd(u23based, "<div class='anncontent'><span class='annfieldname'>功能说明:</span> 用户输入<BR><BR></div>");
...
InsertBeforeEnd(u9based, "<div class='anncontent'><span class='annfieldname'>功能说明:</span> 根据物料编码自动填充，只读框<BR><BR></div>");
...
InsertBeforeEnd(u11based, "<div class='anncontent'><span class='annfieldname'>功能说明:</span> 用户输入<BR><BR></div>");
